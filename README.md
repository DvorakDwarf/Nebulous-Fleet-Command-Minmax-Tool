...
No installation is required, the site is hosted on GitHub Pages and can be viewed [here]. To work with tools offline simply clone the repo, and open index.html in your browser.

Some things may not work without setting up a web server such as https://github.com/lwsjs/local-web-server. Additionally, you can use the shell.nix file provided if you have Nix
